// .ui.xml template last modified: 1571248779012
...
public class ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, GroupId.client.ui.ChangeNoteDialogBox>, GroupId.client.ui.ChangeNoteDialogBox.ChangeNoteDialogBoxUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final GroupId.client.ui.ChangeNoteDialogBox owner) {
   ...
   */
  class Widgets {
    private final GroupId.client.ui.ChangeNoteDialogBox owner;
    ...
    public Widgets(final GroupId.client.ui.ChangeNoteDialogBox owner) {
      this.owner = owner;
     ...
     */
    private GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenBundle) GWT.create(GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenCss_td get_td() {
      return build_td();
    }
    private GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenCss_td build_td() {
      // Creation section.
      final GroupId.client.ui.ChangeNoteDialogBox_ChangeNoteDialogBoxUiBinderImpl_GenCss_td td = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().td();
      // Setup section.
      td.ensureInjected();
    ...
    private com.google.gwt.user.client.ui.Button build_applyButton() {
      ...
      applyButton.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2);
